...
import type { ICategoryType, IPayloadRemoveCategory } from '@renderer/types'
...
export const useDeleteCategoryBy = (
  by: ICategoryType
): UseMutationResult<IMainResponse<boolean>, Error, IPayloadRemoveCategory, unknown> => {
  return useMutation({
